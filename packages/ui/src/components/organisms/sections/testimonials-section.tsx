...
export function TestimonialsSection() {
  ...
  return (
    <section className="relative flex w-full flex-col items-center gap-8 overflow-hidden py-12 sm:gap-10 sm:py-16 md:gap-12 md:py-20 lg:py-24">
      ...
      <div className="bg-linear-to-b absolute inset-0 -z-10 from-transparent via-pink-50/30 to-transparent dark:via-pink-950/10" />
      ...
      <motion.div
        ...
        className="absolute left-1/3 top-20 h-40 w-40 rounded-full bg-pink-200/20 blur-3xl sm:h-56 sm:w-56 md:h-72 md:w-72 dark:bg-pink-800/10"
      />
      <motion.div
        animate={{
          scale: [1, 1.15, 1],
        ...
        className="absolute bottom-20 right-1/3 h-40 w-40 rounded-full bg-purple-200/20 blur-3xl sm:h-56 sm:w-56 md:h-72 md:w-72 dark:bg-purple-800/10"
      />
      ...
      <div className="relative z-10 flex w-full max-w-5xl flex-col items-center gap-8 px-4 sm:gap-10 sm:px-6 md:gap-12 lg:px-8">
        ...
        >
          ...
          <motion.div
            ...
            className="from-primary to-secondary bg-linear-to-br inline-flex items-center justify-center rounded-2xl p-3 shadow-lg"
          >
            <MessageCircle
          ...
          {/* Title */}
          <h2 className="text-foreground text-3xl font-bold leading-tight tracking-tight sm:text-4xl md:text-5xl">
            {" "}
        ...
        <div className="relative w-full max-w-4xl">
          ...
          <button
            ...
            className="from-primary to-secondary bg-linear-to-r absolute left-0 top-1/2 z-10 -translate-x-4 -translate-y-1/2 rounded-full p-2 text-white shadow-lg transition-all hover:scale-110 sm:-translate-x-12 sm:p-3"
          ...
          <button
            ...
            className="from-primary to-secondary bg-linear-to-r absolute right-0 top-1/2 z-10 -translate-y-1/2 translate-x-4 rounded-full p-2 text-white shadow-lg transition-all hover:scale-110 sm:translate-x-12 sm:p-3"
          ...
          <AnimatePresence mode="wait">
            ...
            >
              <div className="bg-card text-card-foreground group relative overflow-hidden rounded-[50px] p-8 shadow-[20px_20px_60px_hsl(var(--color-muted)/0.3),-20px_-20px_60px_hsl(var(--color-card)/1)] backdrop-blur-sm transition-all duration-500 hover:shadow-[25px_25px_70px_hsl(var(--color-muted)/0.4),-25px_-25px_70px_hsl(var(--color-card)/1)] sm:p-10 md:p-12">
                ...
                {/* Quote Icon */}
                <div className="absolute right-8 top-8 opacity-10 sm:right-10 sm:top-10">
          ...
          {testimonials.map((_, index) => (
            <button
              ...
              className={`h-2 rounded-full transition-all ${
                index === currentIndex
                  ? "from-primary to-secondary bg-linear-to-r w-8"
