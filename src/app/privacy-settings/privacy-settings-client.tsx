...
export default function PrivacySettingsClient() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-blue-50 via-purple-50 to-pink-50 py-12 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center gap-3">
            <div className="rounded-full bg-linear-to-r from-blue-600 to-purple-600 p-3 shadow-lg">
