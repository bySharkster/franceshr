...
export function WhyChoose() {
  ...
  return (
    ...
    >
      ...
      <div className="bg-linear-to-b absolute inset-0 -z-10 from-transparent via-indigo-50/30 to-transparent dark:via-indigo-950/10" />
      ...
      <motion.div
        ...
        className="absolute right-1/4 top-10 h-40 w-40 rounded-full bg-purple-200/20 blur-3xl sm:h-56 sm:w-56 md:h-72 md:w-72 dark:bg-purple-800/10"
      />
      <motion.div
        animate={{
          scale: [1, 1.2, 1],
            ...
            >
              ...
              <div className="bg-card text-card-foreground relative flex items-start gap-4 rounded-[50px] p-6 shadow-[20px_20px_60px_hsl(var(--color-muted)/0.3),-20px_-20px_60px_hsl(var(--color-card)/1)] backdrop-blur-sm transition-all duration-500 hover:scale-[1.01] hover:shadow-[25px_25px_70px_hsl(var(--color-muted)/0.4),-25px_-25px_70px_hsl(var(--color-card)/1)] sm:gap-6 sm:p-8">
                ...
                <motion.div
                  ...
                  className="from-primary to-secondary bg-linear-to-br shrink-0 rounded-xl p-3 shadow-md"
                >
                  <reason.icon
