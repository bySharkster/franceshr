...
export function FinalCTA() {
  return (
    <section className="relative flex w-full flex-col items-center gap-8 overflow-hidden py-16 sm:gap-10 sm:py-20 md:gap-12 md:py-24 lg:py-32">
      ...
      <div className="bg-linear-to-br absolute inset-0 -z-10 from-blue-50 via-purple-50 to-pink-50 dark:from-blue-950/30 dark:via-purple-950/30 dark:to-pink-950/30" />
      ...
      <motion.div
        ...
        className="absolute -left-20 -top-20 h-64 w-64 rounded-full bg-blue-300/30 blur-3xl sm:h-80 sm:w-80 md:h-96 md:w-96 dark:bg-blue-700/20"
      />
      <motion.div
        animate={{
          scale: [1, 1.2, 1],
        ...
        className="absolute -bottom-20 -right-20 h-64 w-64 rounded-full bg-purple-300/30 blur-3xl sm:h-80 sm:w-80 md:h-96 md:w-96 dark:bg-purple-700/20"
      />
      ...
      <div className="relative z-10 flex w-full max-w-4xl flex-col items-center gap-8 px-4 text-center sm:gap-10 sm:px-6 md:gap-12 lg:px-8">
        ...
        <motion.div
          ...
          className="from-primary to-secondary bg-linear-to-br inline-flex items-center justify-center rounded-3xl p-4 shadow-2xl sm:p-5"
        >
        ...
        >
          {/* Title */}
          <h2 className="text-foreground text-3xl font-bold leading-tight tracking-tight sm:text-4xl md:text-5xl lg:text-6xl">
        ...
        >
          <Link
            href="#contact"
            className="from-primary to-secondary hover:shadow-3xl bg-linear-to-r group inline-flex items-center gap-3 rounded-xl px-8 py-4 text-lg font-bold text-white shadow-2xl transition-all hover:scale-105 sm:px-10 sm:py-5 sm:text-xl"
          >
        ...
        >
          <div className="text-foreground/60 flex items-center gap-2 text-sm sm:text-base">
            <div className="from-primary to-secondary bg-linear-to-r h-2 w-2 rounded-full" />
