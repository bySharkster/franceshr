...
export function Services() {
  ...
  return (
    ...
    >
      ...
      <div className="bg-linear-to-b absolute inset-0 -z-10 from-transparent via-blue-50/40 to-transparent dark:via-blue-950/20" />
      ...
      <motion.div
        ...
        className="absolute left-1/3 top-20 h-40 w-40 rounded-full bg-blue-200/20 blur-3xl sm:h-56 sm:w-56 md:h-72 md:w-72 dark:bg-blue-800/10"
      />
      <motion.div
        animate={{
          scale: [1, 1.2, 1],
        ...
        className="absolute bottom-20 right-1/3 h-40 w-40 rounded-full bg-indigo-200/20 blur-3xl sm:h-56 sm:w-56 md:h-72 md:w-72 dark:bg-indigo-800/10"
      />
      ...
      <div className="relative z-10 flex w-full max-w-7xl flex-col items-center gap-8 px-4 sm:gap-10 sm:px-6 md:gap-12 lg:px-8">
        ...
        >
          ...
          {/* Title */}
          <h2 className="text-foreground tracking-tight/80 text-3xl font-bold leading-tight sm:text-4xl md:text-5xl">
            Nuestros{" "}
        ...
        >
          <a
            href="#why-choose"
            className="from-primary to-secondary bg-linear-to-r group inline-flex items-center gap-2 rounded-lg px-6 py-3 font-semibold text-white shadow-lg transition-all hover:scale-[1.02] hover:shadow-xl sm:px-8 sm:py-4"
          >
