...
export function CookieConsentBanner() {
  ...
  return (
    <>
      ...
      {/* Banner */}
      <div className="border-border bg-card fixed bottom-0 left-0 right-0 z-50 border-t p-4 shadow-2xl sm:p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-col gap-2 border-t border-gray-200 pt-4 sm:flex-row sm:justify-end dark:border-gray-700">
                ...
                <Button
                  ...
                  className="bg-linear-to-r rounded-lg from-blue-600 to-purple-600 px-4 py-2 text-sm font-semibold text-white shadow-lg transition-all hover:scale-105"
                >
