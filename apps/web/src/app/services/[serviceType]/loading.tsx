  ...
  return (
    <div className="from-primary to-secondary dark:from-background dark:to-background relative min-h-screen bg-gradient-to-b via-blue-50/30 dark:via-blue-950/10">
      ...
      <section className="px-4 py-20 sm:px-6 lg:px-8">
        <div className="from-primary/10 via-secondary/10 bg-linear-to-br mx-auto max-w-4xl rounded-3xl to-pink-50/10 p-8 text-center shadow-xl sm:p-12 dark:from-blue-950/20 dark:via-purple-950/20 dark:to-pink-950/20">
