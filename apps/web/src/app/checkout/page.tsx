      ...
      <div className="mx-auto max-w-2xl">
        ...
        <div className="border-border/40 bg-card/80 rounded-3xl border p-8 shadow-xl backdrop-blur-sm sm:p-12">
          ...
          <div className="mb-8 flex items-start gap-4">
            <div className="from-primary to-secondary bg-linear-to-br rounded-2xl p-3 shadow-lg">
              ...
              <ul className="space-y-2">
                {service.includes.map((item) => (
                  <li key={item} className="text-foreground/70 flex items-start gap-2 text-sm">
                    <span className="from-primary to-secondary bg-linear-to-br mt-1 bg-clip-text text-lg leading-none text-transparent">
                      •
                    </span>
                    {item}
                  </li>
