...
export function ServiceDetailClient({ serviceType }: ServiceDetailClientProps) {
    ...
    <div className="from-primary to-secondary dark:from-background dark:to-background bg-linear-to-b relative min-h-screen via-blue-50/30 dark:via-blue-950/10">
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-16">
            ...
            >
              ...
              <motion.div
                ...
                className="from-primary to-secondary bg-linear-to-br mb-6 inline-flex w-fit items-center justify-center rounded-2xl p-4 shadow-lg"
              >
                <Icon className="text-background h-10 w-10" strokeWidth={1.5} />
              </motion.div>

              {/* Title */}
              <h1 className="text-foreground mb-4 text-4xl font-bold leading-tight tracking-tight sm:text-5xl md:text-6xl">
                {service.title}
              </h1>
              ...
              <Button
                type="button"
                asChild
                className="from-primary to-secondary group/btn bg-linear-to-r inline-flex w-fit items-center gap-2 rounded-full px-8 py-4 text-lg font-semibold text-white shadow-lg transition-all hover:scale-105 hover:shadow-xl"
              >
                <Link
              ...
              <div className="border-border/40 bg-card/80 w-full rounded-3xl border p-8 shadow-xl backdrop-blur-sm">
                ...
                <ul className="space-y-4">
                  {(service.includes || service.features).map((item, index) => (
                    ...
                    >
                      <div className="from-primary to-secondary bg-linear-to-br mt-1 rounded-full p-1">
              ...
              <div className="mt-8">
                ...
                <ul className="grid gap-3 sm:grid-cols-2">
                  {service.features.map((feature, index) => (
                    ...
                    >
                      <Check className="from-primary to-secondary bg-linear-to-br mt-1 h-5 w-5 shrink-0 bg-clip-text text-transparent" />
      ...
      <section className="px-4 py-20 sm:px-6 lg:px-8">
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.6 }}
          className="from-primary/10 via-secondary/10 bg-linear-to-br mx-auto max-w-4xl rounded-3xl to-pink-50/10 p-8 text-center shadow-xl sm:p-12 dark:from-blue-950/20 dark:via-purple-950/20 dark:to-pink-950/20"
        >
          ...
          <Button
            type="button"
            asChild
            className="from-primary to-secondary group/btn bg-linear-to-r inline-flex items-center gap-2 rounded-full px-8 py-4 text-lg font-semibold text-white shadow-lg transition-all hover:scale-105 hover:shadow-xl"
          >
            <Link
              href={service.calComLink || checkoutUrl}
              target={service.calComLink ? "_blank" : "_self"}
