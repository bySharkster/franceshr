...
export default function CookiePolicy() {
  ...
  return (
    <div className="bg-linear-to-br min-h-screen from-blue-50 via-purple-50 to-pink-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="mb-12 text-center">
          <div className="mb-6 flex justify-center">
            <div className="bg-linear-to-r rounded-full from-blue-600 to-purple-600 p-4 shadow-xl">
                ...
                <div className="overflow-x-auto">
                  <table className="w-full text-left text-sm">
                    <thead className="border-b border-gray-300 dark:border-gray-600">
                      <tr>
                        <th className="pb-2 pr-4 font-semibold text-gray-900 dark:text-white">
                          Cookie Name
                        </th>
                        <th className="pb-2 pr-4 font-semibold text-gray-900 dark:text-white">
                          Purpose
